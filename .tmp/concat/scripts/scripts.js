...
app.config([
  ...
  function ($routeProvider) {
    $routeProvider.when('/', {
    ...
    }).when('/contact/:action', { redirectTo: '/contact' }).when('/login', {
    ...
    }).when('/news', { redirectTo: '/news/archive/latest' }).when('/news/new', {
      ...
      templateUrl: 'views/new.html',
      controller: 'NewCtrl'
    }).when('/news/archive', { redirectTo: '/news/archive/latest' }).when('/news/archive/:year', {
      templateUrl: 'views/archive.html',
      controller: 'NewsCtrl'
    }).when('/about', { redirectTo: '/about/us' }).when('/about/partners', {
      templateUrl: 'views/partners.html',
      controller: 'PartnersCtrl'
    }).when('/about/committee-honorary', {
      templateUrl: 'views/committee.html',
      controller: 'ProsCtrl'
    }).when('/tournaments', { redirectTo: '/tournaments/merit' }).when('/tournaments/new', {
      templateUrl: 'views/new.html',
      controller: 'NewCtrl'
    }).when('/tournaments/merit', { redirectTo: '/tournaments/merit/latest' }).when('/tournaments/merit/:year', {
      templateUrl: 'views/merit.html',
      controller: 'TournamentsCtrl'
    }).when('/tournaments/member', { redirectTo: '/tournaments/member/latest' }).when('/tournaments/member/:year', {
      templateUrl: 'views/tournaments.html',
      controller: 'TournamentsCtrl'
    }).when('/tournaments/trainee', { redirectTo: '/tournaments/trainee/latest' }).when('/tournaments/trainee/:year', {
      templateUrl: 'views/tournaments.html',
      controller: 'TournamentsCtrl'
    }).when('/tournaments/:id', {
      ...
      templateUrl: 'views/new.html',
      controller: 'NewCtrl'
    }).when('/pros', { redirectTo: '/pros/directory' }).when('/pros/new', {
      templateUrl: 'views/new.html',
      controller: 'NewCtrl'
    }).when('/pros/directory', {
      ...
      templateUrl: 'views/new.html',
      controller: 'NewCtrl'
    }).when('/honorary', { redirectTo: '/about/committee-honorary' }).when('/honorary/new', { redirectTo: '/pros/new' }).when('/honorary/:id', {
      templateUrl: 'views/pro.html',
      controller: 'ProsCtrl'
    }).when('/honorary/:id/edit', { redirectTo: '/pros/:id/edit' }).when('/community', { redirectTo: '/community/project-skyhigh' }).when('/events', {
      ...
      templateUrl: 'views/new.html',
      controller: 'NewCtrl'
    }).when('/press', { redirectTo: '/press/releases' }).when('/press/:contentType/edit', { redirectTo: '/press' }).when('/press/:contentType/new', {
      templateUrl: 'views/new.html',
      controller: 'NewCtrl'
  ...
  Redactor.fn = $.Redactor.prototype = {
    ...
    buildOptions: function () {
      ...
      if (this.opts.minHeight)
        $source.css('min-height', this.opts.minHeight + 'px');  // FF fix bug with line-height rendering
    ...
    inlineEachNodes: function (callback) {
      var range = this.getRange(), node = this.getElement(), nodes = this.getNodes(), collapsed;
      if (range.collapsed || range.startContainer === range.endContainer && node) {
        nodes = $(node);
        collapsed = true;
      }
    ...
    getCurrent: function () {
      ...
      if (sel && sel.rangeCount > 0) {
        el = sel.getRangeAt(0).startContainer;  //el = sel.getRangeAt(0).commonAncestorContainer;
      }
    ...
    tableInsert: function () {
      ...
      var rows = $('#redactor_table_rows').val(), columns = $('#redactor_table_columns').val(), $table_box = $('<div></div>'), tableId = Math.floor(Math.random() * 99999), $table = $('<table id="table' + tableId + '"><tbody></tbody></table>'), i, $row, z, $column;
      for (i = 0; i < rows; i++) {
        $row = $('<tr></tr>');
        for (z = 0; z < columns; z++) {
...
app.controller('AuthCtrl', [
  ...
  'User',
  'Auth',
  function ($scope, $location, $cookieStore, User, Auth) {
...
/* global app:true */
'use strict';
app.controller('CoverageCtrl', [
  '$scope',
  '$location',
  'Utils',
  'Coverage',
  function ($scope, $location, Utils, Coverage) {
...
app.controller('LangCtrl', [
  ...
  function ($scope, $rootScope, $translate) {
    $scope.changeLanguage = function (langKey) {
      $rootScope.$broadcast('Lang:changeLanguage', langKey);
...
/* global app:true */
'use strict';
app.controller('MagazineCtrl', [
  '$scope',
  '$location',
  'Utils',
  'Magazine',
  function ($scope, $location, Utils, Magazine) {
...
app.controller('MeritCtrl', [
  ...
  function ($scope) {
    ...
    var pointsScored = function (position, days, split) {
      position = position - 1;
...
var ModalInstanceCtrl = function ($scope, $modalInstance, players) {
  ...
  $scope.selected = { winner: $scope.players[0] };
  $scope.ok = function () {
...
app.controller('SidebarCtrl', [
  ...
  '$routeParams',
  'Archive',
  function ($scope, $location, $routeParams, Archive) {
    ...
    var menuStructure = {
        ...
        community: { 'project-skyhigh': 'Project Skyhigh' },
        events: {},
        press: {
          releases: 'Releases',
...
app.controller('NewsCtrl', [
  ...
  'Article',
  'Archive',
  function ($scope, $q, $routeParams, $location, Utils, Article, Archive) {
    ...
    $scope.save = function (a, cb) {
      ...
      Article.create(a).then(updateArchives).then(function () {
...
/* global app:true */
'use strict';
app.controller('ProsCtrl', [
  '$scope',
  '$filter',
  '$location',
  '$routeParams',
  'User',
  function ($scope, $filter, $location, $routeParams, User) {
    $scope.pros = User.all;
    $scope.category = $location.path().split('/')[1];
    ...
    $scope.filterOptions = {
      ...
      committee: [
        ...
        {
          value: 'vice-captain-open',
          name: 'Vice Captain Open'
        },
        {
          value: 'captain-senior',
          name: 'Senior Captain'
        },
        {
          value: 'vice-captain-senior',
          name: 'Vice Senior Captain'
        },
        {
          value: 'captain-ladies',
          name: 'Ladies Captain'
        },
        {
          value: 'vice-captain-ladies',
          name: 'Vice Ladies Captain'
        },
        {
          value: 'committee',
          name: 'Committee'
      ...
      honorary: [
        ...
        {
          value: 'permanent-honorary-president',
          name: 'Permanent Honorary President'
        },
        {
        ...
        {
          value: 'advisor-constitution',
          name: 'Advisor Constitution'
        },
        {
    ...
    $scope.filterItem = { pro: $scope.filterOptions.pros[0] };
...
/* global app:true */
'use strict';
app.controller('TournamentsCtrl', [
  '$scope',
  '$modal',
  '$rootScope',
  '$q',
  ...
  'User',
  'Archive',
  function ($scope, $modal, $rootScope, $q, $timeout, $location, $routeParams, Utils, Tournament, User, Archive) {
    ...
    var calculateRank = function () {
      ...
      angular.forEach($scope.tournament.results, function (players, division) {
        ...
        orderByRank(Utils.sortByKey(players, 'totalScore'), division).then(function (data) {
    ...
    var resolveTiedFirst = function (players) {
      ...
      $scope.openModal('lg').then(function (msg) {
    ...
    var grid2Firebase = function () {
      var promises = [];
      angular.forEach($scope.toScore, function (players, division) {
        var deferred = $q.defer();
    ...
    $scope.getTableStyle = function (division) {
      var rowHeight = 30;
      var headerHeight = 45;
      return { height: $scope.toScore[division].length * rowHeight + headerHeight + 'px' };
    };
        ...
        open: {
          ...
          columnDefs: [
            ...
            },
            {
              ...
              displayName: 'Rank',
              enableCellEdit: false,
              visible: $scope.tournament.scored
            },
            {
              field: 'points',
              displayName: 'Points',
    ...
    $scope.submitScores = function () {
      grid2Firebase().then(calculateRank).then(calculatePoints).then(function () {
        console.log($scope.tournament.results);
        Tournament.updateResults($scope.tournament).then(function () {
          angular.forEach($scope.tournament.results, function (players, division) {
            angular.forEach(players, function (player, username) {
    ...
    $scope.addParticipant = function (t, division, user) {
      ...
      Utils.nestedObject($scope.tournaments[t.created_at], [
        'results',
        division,
        participant.username
      ], participant);
      $timeout(function () {
        Tournament.addParticipant(t, division, participant).then(function () {
    ...
    $scope.removeParticipant = function (t, division, p) {
      ...
      Tournament.removeParticipant(t, division, p).then(function () {
    ...
    $scope.publish = function (t) {
      ...
      $scope.tournaments[t.created_at] = t;
      Tournament.create(t).then(updateArchives).then(function () {
        $scope.reset();
...
/* global app:true */
'use strict';
app.controller('ReleasesCtrl', [
  '$scope',
  '$rootScope',
  '$location',
  'Utils',
  'Release',
  function ($scope, $rootScope, $location, Utils, Release) {
...
/* global app:true */
'use strict';
app.controller('StaticCtrl', [
  '$scope',
  '$location',
  '$routeParams',
  'Utils',
  'Page',
  function ($scope, $location, $routeParams, Utils, Page) {
...
app.factory('Lang', [
  ...
  '$rootScope',
  '$translate',
  function ($firebase, $rootScope, $translate) {
    var Lang = {
        current: function () {
          return $translate.use();
        },
  ...
  function ($firebase, FIREBASE_URL, Utils) {
    ...
    var Tournament = {
        ...
        addParticipant: function (tournament, division, participant) {
          Utils.nestedObject(tournaments[tournament.created_at], [
            'results',
            division,
            participant.username
          ], participant);
        ...
        removeParticipant: function (tournament, division, participant) {
          return tournaments.$child(tournament.created_at).$child('results').$child(division).$remove(participant.username);
        },
        setScored: function (tournament) {
          return tournaments.$child(tournament.created_at).$child('scored').$set(true);
        },
        updatePlayerStatus: function (participant, tournament, division) {
          return tournaments.$child(tournament.created_at).$child('results').$child(division).$child(participant.username).$child('status').$set(participant.status);
        },
        updateResults: function (tournament) {
          return tournaments.$child(tournament.created_at).$child('results').$update(tournament.results);
        },
...
app.factory('User', [
  ...
  'Utils',
  'Auth',
  function ($firebase, $rootScope, FIREBASE_URL, Utils, Auth) {
    ...
    var User = {
        ...
        addTournament: function (user, tournament) {
          ...
          Utils.nestedObject(users[user.username], [
            'results',
            tournament.year,
            tournament.id,
            'status'
        ...
        updateResults: function (user, tournament) {
          ...
          return users.$child(user.username).$child('results').$child(year).$child(tournament.created_at).$update(results);
        },
        removeTournament: function (user, tournament) {
          return users.$child('results').$child(new Date(tournament.created_at).getFullYear()).$remove(tournament.created_at);
        },
        new: function () {
          return {
            'username': '',
